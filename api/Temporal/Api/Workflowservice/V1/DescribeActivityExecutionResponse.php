...
class DescribeActivityExecutionResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *           Token for follow-on long-poll requests. Absent only if the activity is complete.
     *     @type array<\Temporal\Api\Activity\V1\CallbackInfo>|\Google\Protobuf\Internal\RepeatedField $callbacks
     *           Callbacks attached to this activity execution and their current state.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .temporal.api.activity.v1.CallbackInfo callbacks = 6;</code>
     * @param array<\Temporal\Api\Activity\V1\CallbackInfo>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
