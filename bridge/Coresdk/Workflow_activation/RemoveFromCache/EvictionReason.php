...
namespace Coresdk\Workflow_activation\RemoveFromCache;
...
class_alias(EvictionReason::class, \Coresdk\Workflow_activation\RemoveFromCache_EvictionReason::class);
