...
namespace Coresdk\NamespaceInfo;
...
/**
 * Generated from protobuf message <code>coresdk.NamespaceInfo.Limits</code>
 */
...
class_alias(Limits::class, \Coresdk\NamespaceInfo_Limits::class);
